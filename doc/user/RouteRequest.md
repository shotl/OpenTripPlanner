...
|    reluctance                                                                                                |        `double`        | A multiplier for how bad driving is, compared to being in transit for equal lengths of time.                                                             | *Optional* | `1.0`            |  2.0  |
|    parking                                                                                                   |        `object`        | Preferences for parking a vehicle.                                                                                                                       | *Optional* |                  |  2.5  |
|       cost                                                                                                   |        `integer`       | Cost to park a vehicle.                                                                                                                                  | *Optional* | `120`            |  2.0  |
|       time                                                                                                   |       `duration`       | Time to park a vehicle.                                                                                                                                  | *Optional* | `"PT1M"`         |  2.0  |
...
|    [removeTransitWithHigherCostThanBestOnStreetOnly](#rd_if_removeTransitWithHigherCostThanBestOnStreetOnly) | `cost-linear-function` | Limit function for generalized-cost computed from street-only itineries applied to transit itineraries.                                                  | *Optional* |                  |  2.4  |
...
**Path:** /routingDefaults/accessEgress   
**Enum keys:** `not-set` | `walk` | `bike` | `bike-to-park` | `bike-rental` | `scooter-rental` | `car` | `car-to-park` | `car-pickup` | `car-rental` | `car-hailing` | `demand-responsive-transportation` | `flexible`
...
- `demand-responsive-transportation` = (timePenalty: 20m + 2.0 t, costFactor: 1.50)
...
**Since version:** `2.4` ∙ **Type:** `cost-linear-function` ∙ **Cardinality:** `Optional`   
**Path:** /routingDefaults/itineraryFilters 

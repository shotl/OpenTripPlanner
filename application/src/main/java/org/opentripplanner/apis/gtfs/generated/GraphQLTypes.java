...
public class GraphQLTypes {
  ...
  public static class GraphQLDrtInput {
    ...
    public void setGraphQLEgressReluctance(Double egressReluctance) {
  ...
  public static class GraphQLQueryTypePlanArgs {
    ...
    public GraphQLQueryTypePlanArgs(Map<String, Object> args) {
      if (args != null) {
        ...
        this.drt = new GraphQLDrtInput((Map<String, Object>) args.get("drt"));
    ...
    public GraphQLDrtInput getGraphQLDrt() {
      return this.drt;
    }
    ...
    public void setGraphQLDrt(GraphQLDrtInput drt) {
      this.drt = drt;
    }

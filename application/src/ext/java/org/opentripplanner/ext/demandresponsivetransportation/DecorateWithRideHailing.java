...
public class DecorateWithRideHailing implements ItineraryListFilter {
  ...
  private final List<DemandResponsiveTransportationService> rideHailingServices;
  private final boolean wheelchairAccessible;

  public DecorateWithRideHailing(
    List<DemandResponsiveTransportationService> rideHailingServices,
  ...
  private Itinerary addRideHailingInformation(Itinerary i, DemandResponsiveTransportationService service) {
  ...
  private Leg decorateLegWithRideEstimate(Itinerary i, Leg leg, DemandResponsiveTransportationService service) {
    try {

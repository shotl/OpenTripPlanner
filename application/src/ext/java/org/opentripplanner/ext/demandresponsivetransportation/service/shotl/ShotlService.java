 ...
 */
public class ShotlService extends CachingRideHailingService {
  ...
  public List<ArrivalTime> queryArrivalTimes(WgsCoordinate coord, boolean wheelchairAccessible)
    ...
    ShotlArrivalEstimateResponse response = getUberEstimateResponse(
      finalUri,
      ShotlArrivalEstimateResponse.class
    );
  ...
  public List<RideEstimate> queryRideEstimates(RideEstimateRequest request) throws IOException {
    ...
    ShotlTripTimeEstimateResponse response = getUberEstimateResponse(
      finalUri,
      ShotlTripTimeEstimateResponse.class
    );
